        ...
        <FadeSection className="text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            <a href="tel:+12705354510"
              ...
              <span><span className="block text-[10px] tracking-widest uppercase text-[#C9A84C] font-bold leading-none mb-0.5">Jonathan Gil</span>(270) 535-4510</span>
            </a>
          </div>
        </FadeSection>
